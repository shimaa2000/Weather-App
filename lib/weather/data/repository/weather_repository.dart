...
class WeatherRepository extends BaseWeatherRepository {
  ...
  @override
  Future<Either<Failure, Weather>> getWeatherByCityName(Map<String, dynamic> query) async {
    try {
  ...
  @override
  Future<Either<Failure, List<Weather>>> getWeatherForFiveDays(Map<String, dynamic> query) async {
    try {
